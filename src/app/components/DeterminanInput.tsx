          ...
          <div key={rowIndex} className="flex gap-3">
            {row.map((value, colIndex) => (
              <input
                ...
                className="w-14 h-14 text-center text-gray-800 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent hover:border-gray-300 transition-all font-medium"
                placeholder="0"
              />
            ))}
          </div>
